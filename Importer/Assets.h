...
namespace Importer
{
	...
	public:
		...
		IMPORTER_API void bind(ID3D11Device* device, ID3D11DeviceContext* deviceContext)
		{
			m_device = device;
		...
		IMPORTER_API ID3D11Device* GetDevice() {
			return m_device;
		}
		IMPORTER_API ID3D11DeviceContext* GetDeviceContext() {
