	...
	float screenDepth, float screenNear)
{
	...
	//Now create the second depth stencil state witch turns off the Z buffer for 2D rendering the only difference is
	//that DepthEnable is set ot false all other parameter s are the same
	// Set up the description of the stencil state.
